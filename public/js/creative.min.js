...
$(function() {
    $("#imgAnimation1").hover(
        function() {
            $(this).attr("src", "http://spark.tc/assets/img/animations/1_animated.gif");
          },
        function() {
            $(this).attr("src", "http://www.spark.tc/assets/img/animations/1_still.png");
          }
    );
});
...
$(function() {
    $("#imgAnimation2").hover(
        function() {
            $(this).attr("src", "http://spark.tc/assets/img/animations/2_animated.gif");
          },
        function() {
            $(this).attr("src", "http://www.spark.tc/assets/img/animations/2_still.png");
          }
    );
});
...
$(function() {
    $("#imgAnimation3").hover(
        function() {
            $(this).attr("src", "http://spark.tc/assets/img/animations/3_animated.gif");
          },
        function() {
            $(this).attr("src", "http://www.spark.tc/assets/img/animations/3_still.png");
          }
    );
});
